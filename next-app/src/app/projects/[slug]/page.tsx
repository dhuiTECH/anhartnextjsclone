...
export async function generateMetadata({
  ...
  const title = project.title === "162 Main St" ? "162 Main St | Affordable Micro-Suites & Supportive Housing Vancouver" : `${project.title} - Affordable Housing Project | Anhart`;
            ...
            {project.image && (
              <div className="mb-12 rounded-lg overflow-hidden">
                <OptimizedImage
                  ...
                  alt={project.title === "Metson Rooms" ? "Metson Rooms exterior 1060 Howe Street Vancouver affordable housing hotel conversion" : project.title === "162 Main St" ? "Exterior view of 162 Main St Vancouver affordable micro-suite housing development" : project.title}
                  category="portfolio"

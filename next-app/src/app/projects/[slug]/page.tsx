...
export async function generateMetadata({
  ...
  const title = project.title === "162 Main St" ? "162 Main St | Affordable Micro-Suites & Supportive Housing Vancouver" : project.title === "The Ryder" ? "The Ryder Hope BC | Modular Affordable Housing Development | Anhart" : project.title === "Dodson Hotel" ? "Dodson Hotel | Historic Supportive Housing & SRO Renewal Vancouver" : project.title === "Jubilee Rooms" ? "Jubilee Rooms | Historic SRO Renovation & Affordable Housing Vancouver" : project.title === "Skeena House" ? "Skeena House | Indigenous-Led Supportive Housing Vancouver" : `${project.title} - Affordable Housing Project | Anhart`;

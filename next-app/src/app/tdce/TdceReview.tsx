    ...
    <div>
      ...
      <div style={{ marginBottom: '3rem' }}>
        ...
        <p style={{ fontFamily: 'Roboto, sans-serif', fontSize: '1.1rem', color: textMuted, marginTop: 12, lineHeight: 1.5 }}>
          Double check your inputs before generating the final TDCE report.
        </p>
      </div>
      ...
      <div style={{ marginTop: '4rem', display: 'flex', flexDirection: 'column', gap: '1rem', alignItems: 'center' }}>
        <button 
          ...
          style={{
            ...
            background: 'white', color: textDark, border: `2px solid ${borderLight}`, borderRadius: '40px',
          ...
          onMouseEnter={e => !isSubmitting && (e.currentTarget.style.borderColor = brandPrimary)}
          onMouseLeave={e => !isSubmitting && (e.currentTarget.style.borderColor = borderLight)}
        >
          {isSubmitting ? 'Sending...' : 'Send to Anhart Coordinator to discuss next steps'}
        ...
        <button 
          ...
          style={{
            ...
            padding: '20px 48px', fontSize: '1.2rem', fontWeight: 600, cursor: 'pointer',

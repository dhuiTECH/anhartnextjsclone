             ...
             <div className="max-w-md w-full">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
                    ...
                    <button 
                        ...
                        className="inline-block px-8 py-4 text-lg font-bold uppercase tracking-wider transition-colors rounded-lg bg-[#a6906c] text-white hover:bg-[#8b7355] glow-hover cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed">

...
export const portfolioProjects: ProjectData[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Responding to 2021 flood recovery needs",
      "Supporting rural community resilience",
  ...
  },
  {
    ...
    highlights: [
      "120+ prefabricated homes manufactured annually",
      "Advanced modular construction technology",
      "Sustainable building standards and eco-friendly materials",
      "Rapid deployment for affordable housing crisis",
      "Reduces construction time by 40-50%",
      "Scales affordable housing production nationwide",
      "Supports Anhart's 20,000 homes by 2045 goal",

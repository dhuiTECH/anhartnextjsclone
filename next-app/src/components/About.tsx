...
const ourVisionImg =
  typeof ourVisionImport === "string"
    ? ourVisionImport
    : ourVisionImport?.src || "";
const ourApproachImg =
  typeof ourApproachImport === "string"
    ? ourApproachImport
    : ourApproachImport?.src || "";
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 max-w-5xl mx-auto">
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-primary/10 hover:border-primary/30">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground text-sm md:text-lg leading-relaxed">
                      We envision a future where every Canadian community
                      thrives — resilient, and inclusive. Guided by thinking
                      systems and innovation, we see cities not just as
                      collections of buildings, but as living ecosystems shaped
                      by people and technology. Our vision is to empower
                      communities with housing that adapts to change, supports
                      human potential, and creates lasting social value. We aim
                      to build equitable urban environments that uplift all
                      residents.
                    </p>
                  </CardContent>
                </Card>
              ...
              <ScrollAnimationWrapper direction="right" delay={200}>
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 border-primary/10 hover:border-primary/30">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground text-sm md:text-lg leading-relaxed">
                      We believe affordable housing is built through
                      collaboration. Our approach combines practical tools with
                      local partnerships to reduce costs and maximize impact.
                      Whether through modular construction for speed,
                      conventional builds for scale, or retrofits that breathe
                      new life into existing homes, we work alongside
                      nonprofits, municipalities, and community-driven champions
                      to create housing solutions that are accessible, durable,
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <ScrollAnimationWrapper direction="top" delay={100}>
                <p className="text-lg leading-8 text-muted-foreground">
                  Meet the dedicated professionals working to advance affordable
            ...
            <div className="mb-16">
              ...
              <div className="md:hidden">
                ...
                <ScrollAnimationWrapper direction="bottom" delay={300}>
                  <div
                    className={`relative transition-all duration-300 ${isTouchActive ? "shadow-2xl shadow-primary/20" : ""} ${
                      isAnimating
                        ? swipeDirection === "left"
                  ...
                  >
                    ...
                    {/* Single Card Display */}
                    <div className="px-6">
                      {boardMembers[currentBoardIndex] && (
                          ...
                          <div className="w-full max-w-sm">
                            ...
                            >
                              <Card
                                ...
                                onClick={() =>
                                  handleStaffClick(staff[currentStaffIndex])
                                }
                              >
                                <CardContent className="p-6 text-center">
                                  <div className="h-20 w-20 rounded-full bg-muted mx-auto mb-4 flex items-center justify-center">

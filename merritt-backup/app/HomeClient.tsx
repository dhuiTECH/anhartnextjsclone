    ...
    <div className="min-h-screen flex flex-col bg-[#f9f8f6] text-[#1a2621] font-sans antialiased selection:bg-[#1a2621] selection:text-white overflow-x-hidden">
      ...
      <style jsx global>{`
        ...
        .input-underlined {
            ...
            border-bottom: 1px solid rgba(26, 38, 33, 0.3);
            padding: 1rem 0;
            width: 100%;
            outline: none;
            transition: border-color 0.3s ease;
        }
        .input-underlined:focus { border-bottom-color: #a6906c; }
        ...
        .glow-hover::after {
            ...
            background: linear-gradient(
                120deg,
                rgba(166, 144, 108, 0) 0%,
                rgba(166, 144, 108, 0.55) 40%,
                rgba(255, 255, 255, 0.9) 50%,
                rgba(166, 144, 108, 0.55) 60%,
                rgba(166, 144, 108, 0) 100%
            );
            opacity: 0;
      ...
      <section ref={villageRef} className="relative w-full h-[80vh] md:h-[90vh] lg:h-screen sticky top-0 z-0 overflow-hidden bg-white">
        ...
        >
          <picture className="w-full h-full">
            <source srcSet="/fullvillage.webp" type="image/webp" />
            <img
              src="/fullvillage.jpg"

...
export const metadata: Metadata = {
  ...
  description: "Discover Merritt's vibrant community with parks, dining, shopping, schools, and transit. Explore the Nicola Valley lifestyle around Anhart's 3757 De Wolf Way development.",
